<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Profil.aspx.cs" Inherits="Survey.Admin.Hesap.Profil" %>
                        ...
                        <table class="table">
                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <td></td>
                                <td>
                                    <asp:Button ID="btnVazgec" Text="Geri Dön" CssClass="btn btn-danger btn-lg" OnClick="btnVazgec_Click" runat="server" />
