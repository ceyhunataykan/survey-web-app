<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Guncelle.aspx.cs" Inherits="Survey.Admin.Anket.Guncelle" %>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:Button Text="Güncelle" ID="btnGuncelle" CssClass="btn btn-success btn-lg" OnClick="btnGuncelle_Click" runat="server" />
                            </div>
                        </div>
                        <br />
                        <div class="form-group">
