<%@ Page Title="Ankete Katıl" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Katil.aspx.cs" Inherits="Survey.Admin.Anket.Katil" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-primary">
        ...
        <div class="panel-footer">
            <asp:Button CssClass="btn btn-success btn-block" Text="Anketi Bitir" ID="btnKaydet" runat="server" OnClick="btnKaydet_Click" />
        </div>
    </div>
    <br />
    <br />
